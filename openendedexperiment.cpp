...
class tollinit:public vehicleinfo{
    ...
    void setdate()
    {
        cout<<"Enter the present date (dd/mm/yyyy) same formate"<<endl;
        getchar();
        getline(cin,date);
    }
    void tollcalculator()
...
int main()
{
    ...
    int choice,sub;
    int mapping;
    cout<<"||||      WELCOME TO TOLLPLAZA        ||||"<<endl;
    ...
    // }
    // fstream file;
    // file.open("toll.txt",ios::out|ios::in);
    // file.eof();
    // totalvehicle = totalvehicle +vehicle;
    // for (int i = 0; i < vehicle; i++)
    // {
    //     v[i].display();
    //     file<<"==========================================DATE|"<<v[i].date <<"|==================================================="<<endl;
    //     file<<"====================================VEHICLE INFORMATION======================================"<<endl;
    //     file<<"====================================VEHICLE NUMBER: "<<v[i].numberplate <<" ======================================"<<endl;
    //     file<<"====================================VEHICLE OWNER: "<<v[i].ownername <<" ======================================"<<endl;
    //     file<<"====================================VEHICLE NAME: "<<v[i].vehiclename <<" ======================================"<<endl;
    //     file<<"====================================VEHICLE TYPE: "<<v[i].type <<" ======================================"<<endl;
    //     file<<"====================================VEHICLE TRIP (1) one-way (2) two-way : "<<v[i].trip <<" ======================================"<<endl;
    // }
    // file.close();
    ...
    cout<<"(1) for first day of week:"<<endl;
    cout<<"(2) for second day of week:"<<endl;
    cout<<"(3) for third day of week:"<<endl;
    cout<<"(4) for fourth day of week:"<<endl;
    cout<<"(5) for fifth day of week:"<<endl;
    cout<<"(6) for sixth day of week:"<<endl;
    cout<<"(7) for seventh day of week:"<<endl;
    cout<<"(8) for displaying details of week:"<<endl;
    cout<<"(9) for searching mechanism:"<<endl;
    cin>>choice;
    switch (choice)
    {
    case 1:
    ...
    case 8:
        ...
        if (sub==1)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v1[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else if (sub==2)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v2[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else if (sub==3)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v3[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else if (sub==4)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v4[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else if (sub==5)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v5[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else if (sub==6)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v6[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else if (sub==7)
        {
            ...
            newfile<<"====================================TAX PAIED : "<<v7[i].tax <<" ======================================"<<endl<<endl;
            }
            break;
        }
        else
        {
            cout<<"The total collection of the TOLLPLAZA for whole week is "<<day1+day2+day3+day4+day5+day6+day7<<endl;
            cout<<"The Total vehicle passed is "<<v7[vehi7].vehiclecounttwo+v7[vehi7].vehiclecountfour<<endl;
            cout<<"In which two wheelers are "<<v7[vehi7].vehiclecounttwo<<" and four wheelers are "<<v7[vehi7].vehiclecountfour<<endl;
            break;
        }
    case 9:
            getchar();
